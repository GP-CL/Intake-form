...
const Navbar = ({ isLoginPage = false }: NavbarProps) => {
    const [isMenuOpen, setIsMenuOpen] = useState(false);
    


    return (
        <nav className="w-full px-4 sm:px-6 lg:px-8 py-3 sm:py-4 bg-white bg-opacity-80 backdrop-blur-lg shadow-lg fixed top-0 left-0 z-50 border-b border-indigo-100">
